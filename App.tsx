...
const App: React.FC = () => {
  return (
    <div className="relative min-h-screen flex flex-col">
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-4 py-12 md:py-20 z-10">
        <div className="text-center max-w-4xl mx-auto">
          <div className="inline-block mb-4 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-100">
            <span className="text-blue-600 text-sm font-semibold tracking-wide uppercase">Coming Soon</span>
          </div>
